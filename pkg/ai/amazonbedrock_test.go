...
func TestBedrockModelConfig(t *testing.T) {
	...
	foundModel, err := client.getModelFromString("arn:aws:bedrock:us-east-1:108967227212:application-inference-profile/x3ad2t9lemju")
	...
	assert.Equal(t, foundModel.Config.ModelName, "arn:aws:bedrock:us-east-1:108967227212:application-inference-profile/x3ad2t9lemju")
}
...
func TestBedrockGetCompletionInferenceProfile(t *testing.T) {
	modelName := "arn:aws:bedrock:us-east-1:108967227212:application-inference-profile/x3ad2t9lemju"
